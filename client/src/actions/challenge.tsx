 ...
 */
function challengeError(errMsg: string) {
  return {
 ...
 * @returns {Object} Returns a redux action object.
 */
export function saveCode(roomId: string, code: string) {
  return {
    type: SAVE_CODE,
    payload: {
      roomId,
 ...
 * @returns {Object} Returns a redux action object.
 */
export function setCode(room: string, code: string) {
  return {
    type: SET_CODE,
    payload: { room, code },
  };
 ...
 * @returns {Object} Returns a redux action object
 */
export function addInvite(inviteLink: string) {
  return {
 ...
 * @returns {Object} Returns a redux action object.
 */
export function testingCode(roomId: string) {
  return {
    type: TEST_CODE,
    payload: roomId,
  };
 ...
 */
export function getChallenge(cId: string, rId: string) {
  return (dispatch: Dispatch) => {
    ajaxRequest(`/api/challenge/${cId}/room/${rId}`)
      .then((res) => {
 ...
 */
export function convertRoomToPublic(rId: string) {
  return (dispatch: Dispatch) => {
    ajaxRequest(`/api/room/${rId}/public`, "POST")
      .then((res) => {
...
export function testCode(
  ...
  return (dispatch: Dispatch) => {
    ...
    ajaxRequest(`/api/challenge/${cId}/room/${rId}/test`, "POST", {
      code,
      language,
    }).catch((err) => {
      dispatch(challengeError(err.response.data));
