 ...
 */
export function addUserTyping(username: string) {
  return {
 ...
 * @returns {Object} Returns a redux action object.
 */
export function removeUserTyping(username: string) {
  return {
    type: USER_TYPE_END,
    payload: username,
  };
 ...
 * @returns {Object} Returns a redux action object.
 */
export function sendMessage(room: string, msg: string, userId: string) {
  return {
    type: SEND_MESSAGE,
 ...
 * @returns {Object} Returns a redux action object.
 */
export function setInitialMessages(messages: any) {
  return {
